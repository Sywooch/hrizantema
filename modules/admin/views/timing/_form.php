...
<div class="news-form">
    ...
    <?php
    if ($model->is_dow!=='0'&&$model->is_dow!==0){
    ...
    <div class="col-sm-6 col-sm-offset-3 " style="display:<?php echo ($model->is_dow=='0')?'none':'block'?>;float:none" id="repeat_block"><?= DualListbox::widget([
        ...
        'attribute' => 'dow',
        'items' => ['1'=>'Понедельник','2'=>'Вторник','3'=>'Среда','4'=>'Четверг','5'=>'Пятница','6'=>'Суббота','0'=>'Воскресенье'],

        'options' => [
            'multiple' => true,
            'size' => 10,
        ],
        //'selection'=>($model->is_dow=='0')?'':explode(',',$model->dow),
        'clientOptions' => [
            'moveOnSelect' => false,
