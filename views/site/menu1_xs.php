...
<div class='col-lg-12 hidden-lg hidden-md' style='padding-top:40px; '>
    ...
    echo Panel::widget([
        'options'=>[
         ...
         'content' => 'Формула успеха уже давно не является ни для кого секретом. Профессиональный успех складывается из трех неотъемлемых составляющих. Это репутация, квалификация и связи. На словах все просто. На практике же мы каждый день на протяжении многих лет много работаем для того, чтобы все три ключа к успеху оказались в руках наших студентов, будущих профессионалов. 
      Частное образовательное учреждение дополнительного профессионального образования «Хризантема»  было и остается учебным заведением, занимающимся подготовкой специалистов в области стиля и красоты. ', // some content in body
         'footer' => false, // show footer or false not showing
         'type' => true, // get style for panel \amass\panel::TYPE_DEFAULT  default
]); 
    echo "</div>";
...
<div class='col-lg-12 hidden-lg hidden-md' style=''>
    ...
    echo Panel::widget([
        'options'=>[
         ...
         'content' => 'В программу обучения входят курсы и семинары  для начинающих, углубленные курсы по коммерческим технологиям,  курсы повышения квалификации  для профессионалов, давно работающих на рынке. 
