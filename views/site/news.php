...
<div class="col-lg-4 col-md-4 col-sm-8 col-xs-12 col-sm-offset-2 col-lg-offset-0 col-md-offset-0">
    ...
    'items' => [
        ...
        [
            'label' => "<div style='text-align:center; font-size:12pt' class='news-upper'>Еще новости</div>",
            'content' => $cont,
        ...
        [
            'label' => "<div style='text-align:center; font-size:12pt' class='news-upper'>Новинки</div>",
            'content' => $cont5,   
            'contentOptions' => ['class' => 'without-padding'],
            'encode'=>false
        ],
...
<?php
 if (Yii::$app->user->isGuest !== false) {
     echo "Только авторизованные пользователи могут оставлять комментарии. ".Html::a('Войти...',['site/login']) ; 
 }
