...
$seo = SeoPages::find()->where(['name'=>'news'])->one();
...
foreach ($model as $new) {
   ...
   $news = $news.Html::a("<div class='news-img col-lg-4 col-md-4 col-sm-4 col-xs-4'><img class='img-responsive' style='max-height:130px;' src='".$new->img."'/></div>",['site/news','id'=>$new->id]);
